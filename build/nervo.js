...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "4e2e55335e0421d923fe";
...
/* harmony import */ var _Decorators__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./Decorators */ "./src/js/Core/Decorators.js");
/* harmony import */ var _Root__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./Root */ "./src/js/Core/Root.js");
...
function (_Root) {
  ...
  return Family;
}(_Root__WEBPACK_IMPORTED_MODULE_19__["default"]), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "clone", [_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      ...
      _Root__WEBPACK_IMPORTED_MODULE_19__["default"].Instances.push(clone);
      return clone;
    };
  }
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "add", [_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (object) {
      ...
      if (object && object.isNervo) {
        if (_this3.isTween || _this3.isSpring) {
          console.warn("Nervo.Family.add: Object is an instance of Nervo.Tween or Nervo.Spring and can't have children.", object);
          return _this3;
        }
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "remove", [_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "_updateChildrenByTime", [_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "_onChange", [_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
function (_Family) {
  ...
  */
  function Ticker(options) {
    ...
    _initializerDefineProperty(_this, "setDelay", _descriptor2, _assertThisInitialized(_this));
    ...
    _initializerDefineProperty(_this, "stop", _descriptor5, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "pause", _descriptor6, _assertThisInitialized(_this));

    _initializerDefineProperty(_this, "play", _descriptor7, _assertThisInitialized(_this));

    _this._execute = function (e) {};

    _initializerDefineProperty(_this, "_updateProgress", _descriptor8, _assertThisInitialized(_this));

    _this._update = function (t) {
      _this._updateProgress(t - _this.delay);
      ...
      if (_this.isTween) {
        ...
        _this._updateChildrenByTime(updateTime);
      }
    ...
    _initializerDefineProperty(_this, "_tick", _descriptor9, _assertThisInitialized(_this));
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, "setDelay", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "start", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "stop", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "pause", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "play", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor8 = _applyDecoratedDescriptor(_class.prototype, "_updateProgress", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (t) {
      ...
      if (_this8.progress >= 1.0) {
        _this8.progress = 1.0;
        _this8.easedProgress = 1.0;
      } else if (_this8.progress < 0) {
        _this8.progress = -1.0;
        _this8.easedProgress = -1.0;
      }
    };
  }
}), _descriptor9 = _applyDecoratedDescriptor(_class.prototype, "_tick", [_Decorators__WEBPACK_IMPORTED_MODULE_19__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function () {
      if (_this9.paused) return;
      /* Update time. */

      _this9.currentTime += _this9._clock.getDelta();
      /* Trigger update to calculate actual progress. */

      _this9._update(_this9.currentTime);

      requestAnimationFrame(_this9._tick);
    };
  }
})), _class);
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./../index */ "./src/js/index.js");
/* harmony import */ var _Core_Root__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../Core/Root */ "./src/js/Core/Root.js");
...
function (_Root) {
  ...
  function Spring(from, to) {
    ...
    _initializerDefineProperty(_this, "springTo", _descriptor3, _assertThisInitialized(_this));
    ...
    _this.from = from;
    _this.to = to;
    _this.target = options.target !== undefined ? options.target : _objectSpread({}, _this.from);
  ...
  return Spring;
}(_Core_Root__WEBPACK_IMPORTED_MODULE_20__["default"]), _class2.Stiffness = 0.2, _class2.Damping = 0.5, _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "isSpring", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "springTo", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "disable", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor5 = _applyDecoratedDescriptor(_class.prototype, "enable", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "_update", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (e) {
      ...
      for (var key in _this5.to) {
        if (_this5.target[key] !== _this5.to[key]) {
          var valueDelta = _this5.target[key] - _this5.to[key];
          ...
          _this5.target[key] += _this5._velocities[key];
        } else {
          isComplete = true;
        }
      }
...
}), _descriptor7 = _applyDecoratedDescriptor(_class.prototype, "_tick", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_18__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
function (_Ticker) {
  ...
  return Timeline;
}(_Core_Ticker__WEBPACK_IMPORTED_MODULE_16__["default"]), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "isTimeline", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_15__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
function (_Ticker) {
  ...
  function Tween(from, to) {
    ...
    _this.from = from;
    _this.to = to;
    _this.target = options.target !== undefined ? options.target : {};
    if (_this.autoStart) _this.start();
    return _this;
  }

  return Tween;
}(_Core_Ticker__WEBPACK_IMPORTED_MODULE_16__["default"]), _temp), (_descriptor = _applyDecoratedDescriptor(_class.prototype, "isTween", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_15__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class.prototype, "setDuration", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_15__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "_execute", [_Core_Decorators__WEBPACK_IMPORTED_MODULE_15__["readonly"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
    ...
    return function (e) {
      for (var key in _this3.to) {
        _this3.target[key] = _this3.from[key] + (_this3.to[key] - _this3.from[key]) * _this3.easedProgress;
      }
    };
  }
})), _class);
